...
public Action Cmd_LockStrings(int iArgs)
{
	g_bAreStringsLocked = true;
	return Plugin_Handled;
}

public Action Cmd_AddReadyString(int iArgs)
{
...
public Action Cmd_ResetStringCount(int iArgs)
{
	g_iStringCount = 0;
...
public Action panelTimer(Handle hTimer)
{
